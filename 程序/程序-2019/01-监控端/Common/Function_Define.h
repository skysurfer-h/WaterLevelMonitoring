...
#define P00_Quasi_Mode				P0M1&=~SET_BIT0;P0M0&=~SET_BIT0
#define P01_Quasi_Mode				P0M1&=~SET_BIT1;P0M0&=~SET_BIT1
#define P02_Quasi_Mode				P0M1&=~SET_BIT2;P0M0&=~SET_BIT2
#define P03_Quasi_Mode				P0M1&=~SET_BIT3;P0M0&=~SET_BIT3
#define P04_Quasi_Mode				P0M1&=~SET_BIT4;P0M0&=~SET_BIT4
#define P05_Quasi_Mode				P0M1&=~SET_BIT5;P0M0&=~SET_BIT5
#define P06_Quasi_Mode				P0M1&=~SET_BIT6;P0M0&=~SET_BIT6
#define P07_Quasi_Mode				P0M1&=~SET_BIT7;P0M0&=~SET_BIT7
#define P10_Quasi_Mode				P1M1&=~SET_BIT0;P1M0&=~SET_BIT0
#define P11_Quasi_Mode				P1M1&=~SET_BIT1;P1M0&=~SET_BIT1
#define P12_Quasi_Mode				P1M1&=~SET_BIT2;P1M0&=~SET_BIT2
#define P13_Quasi_Mode				P1M1&=~SET_BIT3;P1M0&=~SET_BIT3
#define P14_Quasi_Mode				P1M1&=~SET_BIT4;P1M0&=~SET_BIT4
#define P15_Quasi_Mode				P1M1&=~SET_BIT5;P1M0&=~SET_BIT5
#define P16_Quasi_Mode				P1M1&=~SET_BIT6;P1M0&=~SET_BIT6
#define P17_Quasi_Mode				P1M1&=~SET_BIT7;P1M0&=~SET_BIT7
#define P30_Quasi_Mode				P3M1&=~SET_BIT0;P3M0&=~SET_BIT0
//------------------- Define Port as Push Pull mode -------------------
#define P00_PushPull_Mode			P0M1&=~SET_BIT0;P0M0|=SET_BIT0
#define P01_PushPull_Mode			P0M1&=~SET_BIT1;P0M0|=SET_BIT1
#define P02_PushPull_Mode			P0M1&=~SET_BIT2;P0M0|=SET_BIT2
#define P03_PushPull_Mode			P0M1&=~SET_BIT3;P0M0|=SET_BIT3
#define P04_PushPull_Mode			P0M1&=~SET_BIT4;P0M0|=SET_BIT4
#define P05_PushPull_Mode			P0M1&=~SET_BIT5;P0M0|=SET_BIT5
#define P06_PushPull_Mode			P0M1&=~SET_BIT6;P0M0|=SET_BIT6
#define P07_PushPull_Mode			P0M1&=~SET_BIT7;P0M0|=SET_BIT7
#define P10_PushPull_Mode			P1M1&=~SET_BIT0;P1M0|=SET_BIT0
#define P11_PushPull_Mode			P1M1&=~SET_BIT1;P1M0|=SET_BIT1
#define P12_PushPull_Mode			P1M1&=~SET_BIT2;P1M0|=SET_BIT2
#define P13_PushPull_Mode			P1M1&=~SET_BIT3;P1M0|=SET_BIT3
#define P14_PushPull_Mode			P1M1&=~SET_BIT4;P1M0|=SET_BIT4
#define P15_PushPull_Mode			P1M1&=~SET_BIT5;P1M0|=SET_BIT5
#define P16_PushPull_Mode			P1M1&=~SET_BIT6;P1M0|=SET_BIT6
#define P17_PushPull_Mode			P1M1&=~SET_BIT7;P1M0|=SET_BIT7
#define P30_PushPull_Mode			P3M1&=~SET_BIT0;P3M0|=SET_BIT0
#define GPIO1_PushPull_Mode		P1M1&=~SET_BIT0;P1M2|=SET_BIT0
//------------------- Define Port as Input Only mode -------------------
#define P00_Input_Mode				P0M1|=SET_BIT0;P0M0&=~SET_BIT0
#define P01_Input_Mode				P0M1|=SET_BIT1;P0M0&=~SET_BIT1
#define P02_Input_Mode				P0M1|=SET_BIT2;P0M0&=~SET_BIT2
#define P03_Input_Mode				P0M1|=SET_BIT3;P0M0&=~SET_BIT3
#define P04_Input_Mode				P0M1|=SET_BIT4;P0M0&=~SET_BIT4
#define P05_Input_Mode				P0M1|=SET_BIT5;P0M0&=~SET_BIT5
#define P06_Input_Mode				P0M1|=SET_BIT6;P0M0&=~SET_BIT6
#define P07_Input_Mode				P0M1|=SET_BIT7;P0M0&=~SET_BIT7
#define P10_Input_Mode				P1M1|=SET_BIT0;P1M0&=~SET_BIT0
#define P11_Input_Mode				P1M1|=SET_BIT1;P1M0&=~SET_BIT1
#define P12_Input_Mode				P1M1|=SET_BIT2;P1M0&=~SET_BIT2
#define P13_Input_Mode				P1M1|=SET_BIT3;P1M0&=~SET_BIT3
#define P14_Input_Mode				P1M1|=SET_BIT4;P1M0&=~SET_BIT4
#define P15_Input_Mode				P1M1|=SET_BIT5;P1M0&=~SET_BIT5
#define P16_Input_Mode				P1M1|=SET_BIT6;P1M0&=~SET_BIT6
#define P17_Input_Mode				P1M1|=SET_BIT7;P1M0&=~SET_BIT7
#define P30_Input_Mode				P3M1|=SET_BIT0;P3M0&=~SET_BIT0
//-------------------Define Port as Open Drain mode -------------------
#define P00_OpenDrain_Mode		P0M1|=SET_BIT0;P0M0|=SET_BIT0
#define P01_OpenDrain_Mode		P0M1|=SET_BIT1;P0M0|=SET_BIT1
#define P02_OpenDrain_Mode		P0M1|=SET_BIT2;P0M0|=SET_BIT2
#define P03_OpenDrain_Mode		P0M1|=SET_BIT3;P0M0|=SET_BIT3
#define P04_OpenDrain_Mode		P0M1|=SET_BIT4;P0M0|=SET_BIT4
#define P05_OpenDrain_Mode		P0M1|=SET_BIT5;P0M0|=SET_BIT5
#define P06_OpenDrain_Mode		P0M1|=SET_BIT6;P0M0|=SET_BIT6
#define P07_OpenDrain_Mode		P0M1|=SET_BIT7;P0M0|=SET_BIT7
#define P10_OpenDrain_Mode		P1M1|=SET_BIT0;P1M0|=SET_BIT0
#define P11_OpenDrain_Mode		P1M1|=SET_BIT1;P1M0|=SET_BIT1
#define P12_OpenDrain_Mode		P1M1|=SET_BIT2;P1M0|=SET_BIT2
#define P13_OpenDrain_Mode		P1M1|=SET_BIT3;P1M0|=SET_BIT3
#define P14_OpenDrain_Mode		P1M1|=SET_BIT4;P1M0|=SET_BIT4
#define P15_OpenDrain_Mode		P1M1|=SET_BIT5;P1M0|=SET_BIT5
#define P16_OpenDrain_Mode		P1M1|=SET_BIT6;P1M0|=SET_BIT6
#define P17_OpenDrain_Mode		P1M1|=SET_BIT7;P1M0|=SET_BIT7
#define P30_OpenDrain_Mode		P3M1|=SET_BIT0;P3M0|=SET_BIT0
//--------- Define all port as quasi mode ---------
#define Set_All_GPIO_Quasi_Mode			P0M1=0;P0M0=0;P1M1=0;P1M0=0;P3M1=0;P3M0=0
